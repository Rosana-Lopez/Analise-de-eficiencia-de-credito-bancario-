IF OBJECT_ID('decisoes', 'U') IS NOT NULL DROP TABLE decisoes;
IF OBJECT_ID('solicitacoes_credito', 'U') IS NOT NULL DROP TABLE solicitacoes_credito;
IF OBJECT_ID('analistas', 'U') IS NOT NULL DROP TABLE analistas;
